...
class _EditProfileState extends State<EditProfile> {
  ...
  Future init() async {
    ...
    setState(() {
      ...
      _teamName = new TextEditingController(text: teamName);
    });
  }
...
class EditProfile2 extends StatefulWidget {
  final String firstName, lastName, teamName;
...
class EditProfile3 extends StatefulWidget {
  final String firstName, lastName, teamName, aboutYou, favMovie, function;
