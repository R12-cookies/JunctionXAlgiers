                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (ctx, i) {
                            if (snapshot.data.docs[i].data()['id_user'] != userId &&
                                snapshot.data.docs[i].data()["msg"] != "imgurl") {
                              return SentMessageWidget(
                                i: snapshot.data.docs[i].data()["msg"],
                                nom: snapshot.data.docs[i].data()["nom"],
                                userId: snapshot.data.docs[i].data()['id_user'],
                                imgUrl: "",
                                imgProfil:
                                    snapshot.data.docs[i].data()["imgProfil"],
                                help: snapshot.data.docs[i].data()["help"],
                              );
                            } else if (snapshot.data.docs[i].data()['id_user'] ==
                                    userId &&
                                snapshot.data.docs[i].data()["msg"] != "imgurl") {
                              return InkWell(
                                onLongPress: () =>
                                    _showDialog(snapshot.data.docs[i]),
                                child: ReceivedMessagesWidget(
                                  ...
                                  help: snapshot.data.docs[i].data()["help"],
                                    ...
                                    userId &&
                                snapshot.data.docs[i].data()["imgUrl"] != "") {
                              return InkWell(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                              ...
                              return InkWell(
                                  ...
                                  //onLongPress: () => _showDialog(snapshot.data.docs[i]),
                                  child: SentMessageWidget(
                                    ...
                                    nom: snapshot.data.docs[i].data()["nom"],
                                    userId:
                                        snapshot.data.docs[i].data()['id_user'],
                                    imgProfil:
                                        snapshot.data.docs[i].data()["imgProfil"],
                                    help: snapshot.data.docs[i].data()["help"],
                                  ));
